...
class MainMenuState extends MusicBeatState
{
	...
	public static var mackeryEngineVersion:String = '0.1.0'; //This is the Engines Version
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Mackery Engine v" + mackeryEngineVersion, 12);
